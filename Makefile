all: interact_ackermann_call_stack interact_ackermann-hs
...
#
# interact_ackermann_before_relocation: interact_ackermann_before_relocation.c
# 	LD_RUN_PATH=/usr/local/lib cc -o interact_ackermann_before_relocation interact_ackermann_before_relocation.c -L/usr/local/lib -I/usr/local/include -lgjalloc -O3
